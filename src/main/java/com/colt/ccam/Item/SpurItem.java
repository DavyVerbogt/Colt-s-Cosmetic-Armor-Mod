...
import com.colt.ccam.client.render.entity.model.curio.SpurCurioModel;
...
public class SpurItem  extends CurioItem{
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(ColtCosmeticArmorMod.MOD_ID, "textures/models/curio/spur_curio.png");

    @Override
    @OnlyIn(Dist.CLIENT)
    protected BipedModel<LivingEntity> createModel() {
        return new SpurCurioModel(1f);
    }

...
import com.colt.ccam.client.render.entity.model.curio.PonchoSideCurioModel;
...
public class PonchoSideItem  extends CurioItem{

    private static final ResourceLocation TEXTURE = new ResourceLocation(ColtCosmeticArmorMod.MOD_ID, "textures/models/curio/ponchoside_curio.png");

    @Override
    @OnlyIn(Dist.CLIENT)
    protected BipedModel<LivingEntity> createModel() {
        return new PonchoSideCurioModel(1f);
    }

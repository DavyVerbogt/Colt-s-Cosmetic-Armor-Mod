...
import com.colt.ccam.client.render.entity.model.curio.DogTailCurio;
...
public class DogTailItem  extends CurioItem{
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(ColtCosmeticArmorMod.MOD_ID, "textures/models/curio/dogtail_curio.png");

    @Override
    @OnlyIn(Dist.CLIENT)
    protected BipedModel<LivingEntity> createModel() {
        return new DogTailCurio(1f);
    }

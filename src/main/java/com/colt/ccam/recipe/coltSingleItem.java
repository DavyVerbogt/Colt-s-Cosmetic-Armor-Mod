...
//This is normaly not needed, But normal singleItem is private and cant be accesed

public abstract class coltSingleItem implements Recipe<Container> {
	...
	public coltSingleItem(RecipeType<?> p_i50023_1_, RecipeSerializer<?> p_i50023_2_, ResourceLocation p_i50023_3_, String p_i50023_4_, Ingredient p_i50023_5_, ItemStack p_i50023_6_) {
        ...
        public static class Serializer<T extends coltSingleItem> extends net.minecraftforge.registries.ForgeRegistryEntry<RecipeSerializer<?>> implements RecipeSerializer<T> {
            ...
            public interface IRecipeFactory<T extends coltSingleItem> {

...
public class LongSmalTophatArmorModel extends BipedModel<LivingEntity> {

    public LongSmalTophatArmorModel(float modelSize) {
        super(modelSize, 0.0F, 64, 64);

        ModelRenderer TopHat = new ModelRenderer(this);
        TopHat.setRotationPoint(4.0F, -7.0F, 4.0F);
        bipedHead.addChild(TopHat);
        setRotationAngle(TopHat, -0.2618F, 0.0F, 0.2618F);
        TopHat.setTextureOffset(52, 48).addBox(-2.0F, -14.25F, -3.0F, 3.0F, 13.0F, 3.0F, 0.0F, false);

...
public class ColtArmorModel extends HumanoidModel {
    ...
    public static LayerDefinition createArmorLayer(CubeDeformation deformation) {
        ...
        PartDefinition JacketRightLeg = left_leg.addOrReplaceChild("JacketRightLeg", CubeListBuilder.create().texOffs(1, 41).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition JacketLeftLeg = right_leg.addOrReplaceChild("JacketLeftLeg", CubeListBuilder.create().texOffs(1, 41).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        PartDefinition JacketLeftArm = left_arm.addOrReplaceChild("JacketLeftArm", CubeListBuilder.create().texOffs(41, 41).mirror().addBox(0.0F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false), PartPose.offset(1F, -1F, -1F));

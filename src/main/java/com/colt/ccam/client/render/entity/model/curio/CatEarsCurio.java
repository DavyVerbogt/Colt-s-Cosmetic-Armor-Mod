...
public class CatEarsCurio extends BipedModel<LivingEntity> {
    ...
    /*
     * public class custom_model extends EntityModel<Entity> { private final
     * ModelRenderer bipedHead; private final ModelRenderer EarL; private final
     * ModelRenderer EarR;
     * 
     * public custom_model() { textureWidth = 64; textureHeight = 64;
     */
     ...
     * alpha){ bipedHead.render(matrixStack, buffer, packedLight, packedOverlay); }
     */

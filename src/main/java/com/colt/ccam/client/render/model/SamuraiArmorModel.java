...
public class SamuraiArmorModel extends HumanoidModel {
	...
	public static LayerDefinition createArmorLayer(CubeDeformation deformation) {
		...
		left_leg.addOrReplaceChild("bipedRightLeg", CubeListBuilder.create().texOffs(38, 122).mirror().addBox(-2.0F, 10.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Front3 = left_leg.addOrReplaceChild("Front3", CubeListBuilder.create(), PartPose.offset(-0.5F, 2.5F, -2.2F));
		...
		PartDefinition Flaps = left_leg.addOrReplaceChild("Flaps", CubeListBuilder.create(), PartPose.offset(2.5F, 2.5F, -0.1F));
		...
		PartDefinition Back2 = left_leg.addOrReplaceChild("Back2", CubeListBuilder.create(), PartPose.offset(3.5F, 2.5F, 2.2F));
		...
		right_leg.addOrReplaceChild("bipedLeftLeg", CubeListBuilder.create().texOffs(38, 122).addBox(-2.0F, 10.0F, -2.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offset(-0.0F, 0.0F, 0.0F));

		PartDefinition Front2 = right_leg.addOrReplaceChild("Front2", CubeListBuilder.create(), PartPose.offset(3.5F, 2.5F, -2.2F));
		...
		PartDefinition Flaps2 = right_leg.addOrReplaceChild("Flaps2", CubeListBuilder.create(), PartPose.offset(-2.5F, 2.5F, -0.1F));
		...
		PartDefinition Back = right_leg.addOrReplaceChild("Back", CubeListBuilder.create(), PartPose.offset(3.5F, 2.5F, 2.2F));
		...
		PartDefinition ArmArmorR = right_arm.addOrReplaceChild("ArmArmorR", CubeListBuilder.create().texOffs(0, 90).addBox(0.4561F, -2.7F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.3F))
				.texOffs(18, 104).mirror().addBox(0.378F, -1.8853F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false), PartPose.offset(-3.3F, 1.F, 0.0F));
		...
		PartDefinition SholderPiceR = right_arm.addOrReplaceChild("SholderPiceR", CubeListBuilder.create().texOffs(0, 85).mirror().addBox(1.2841F, 0.0738F, -3.5F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false), PartPose.offset(-3.5622F, -2F, 1.5F));
		...
		PartDefinition SholderPiceL = left_arm.addOrReplaceChild("SholderPiceL", CubeListBuilder.create().texOffs(0, 85).addBox(-3.2841F, 0.0738F, -3.5F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offset(3.5622F, -2, 1.5F));
		...
		PartDefinition ArmArmorL = left_arm.addOrReplaceChild("ArmArmorL", CubeListBuilder.create().texOffs(0, 90).addBox(-1.4F, -2.6F, -2.0F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.3F))
				.texOffs(18, 104).addBox(-4.378F, -1.8853F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offset(3.3F, 1.F, 0.0F));
		...
		PartDefinition Helmet = head.addOrReplaceChild("Helmet", CubeListBuilder.create().texOffs(0, 117).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 3.0F, 8.0F, new CubeDeformation(0.2F)), PartPose.offset(0.0F, -0.0F, 0.0F));
		...
		PartDefinition HornR = Helmet.addOrReplaceChild("HornR", CubeListBuilder.create().texOffs(50, 118).addBox(1.0F, -9.0F, -4.6F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
				...
				.texOffs(46, 120).addBox(2.0F, -13.0F, -4.6F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.0F, 0.0F));
		PartDefinition HornR2 = Helmet.addOrReplaceChild("HornR2", CubeListBuilder.create().texOffs(50, 118).mirror().addBox(-2.0F, -9.0F, -4.6F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				...
				.texOffs(46, 120).mirror().addBox(-3.0F, -13.0F, -4.6F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, -0.0F, 0.0F));

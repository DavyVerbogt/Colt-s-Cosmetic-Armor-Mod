...
public class TopTopTopArmorItem extends ArmorItem implements IDyeableArmorItem{
    ...
    public TopTopTopArmorItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builderIn) {
        super(materialIn, slot, builderIn);
    }
    @Override
	public <A extends BipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default) {
		return ColtCosmeticArmorMod.SIDED_SYSTEM.getTopTopTopHatArmorModel(armorSlot);
	}

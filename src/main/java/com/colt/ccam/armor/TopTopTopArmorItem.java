...
public class TopTopTopArmorItem extends ArmorItem implements DyeableLeatherItem{

    public TopTopTopArmorItem(ArmorMaterial materialIn, EquipmentSlot slot) {
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        ...
        p_41423_.add(new TranslatableComponent("§bThis is just a tophat on a tophat on a tophat"));
	}
}
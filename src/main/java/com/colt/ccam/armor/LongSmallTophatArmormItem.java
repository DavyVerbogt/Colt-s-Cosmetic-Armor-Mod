...
public class LongSmallTophatArmormItem extends ArmorItem implements DyeableLeatherItem {

    public LongSmallTophatArmormItem(ArmorMaterial materialIn, EquipmentSlot slot ) {

...
public class SmallTopHatArmorItem extends ArmorItem implements DyeableLeatherItem{

    public SmallTopHatArmorItem(ArmorMaterial materialIn, EquipmentSlot slot ) {

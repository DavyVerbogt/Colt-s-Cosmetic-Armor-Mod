...
public interface  ISidedReference {
        ...
        default <A> A getSamuraiArmorModel(EquipmentSlotType armorSlot) {
            return null;
        }
        default <A> A getCowArmorModel(EquipmentSlotType armorSlot) {
            return null;
        }
        ...
        default <A> A getMileStoneGlassesArmorModel(EquipmentSlotType armorSlot) {
            return null;
        }
